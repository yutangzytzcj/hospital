  ...
  <tr>
	<td valign="top" align="left" class="pad5">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="dqbg margb5">
          <tr>
            <td  align="center" class="lan13b">
               医生姓名： <input  name="ysxm" value=""   maxlength="32"/>
		...
		<table border="0" cellspacing="0" cellpadding="0" class="margb5">
          <tr>
            <td width="61" align="left" class="padr5"><input type="image" src="<%=path%>/images/pic-13.jpg" onClick="window.location.href='adduser.jsp'"></td>
...
<td nowrap align="center"><%=rs.getString("number")%></td>
	   ...
	   <td nowrap align="center"><%=rs.getString("birthtime")==null?"":rs.getString("birthtime")%></td>
	    <td nowrap align="center"><%=rs.getString("worktime")==null?"":rs.getString("worktime")%></td>
         ...
         <td nowrap align="center"><a href="modifyuser.jsp?id=<%=id%>">修改</a> | <a href="deleteuser.jsp?id=<%=id%>">删除</a></td>
